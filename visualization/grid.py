...
class GridPainting:
    ...
    def paint(self):
        ...
        img.save(f"/workspaces/Palette/outputs/Grid {self.grid_size[0]} by {self.grid_size[1]}.png")


if __name__ == "__main__":
    logo_painting = GridPainting('/workspaces/Palette/images/passport', num_logos=1000, image_size=[90,160], grid_size=[15,15])
    logo_painting.paint()
